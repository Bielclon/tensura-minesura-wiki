(function () {
  ...
  const I18N = {
    es: {
      ...
      homeIntro: (n, m) => `Wiki no oficial del mod. Documenta las <strong>${n} Unique Skills</strong> obtenibles de forma natural al reencarnar y los <strong>${m} comandos</strong> que añade el mod. Usa el buscador o el menú de la izquierda para navegar.`,
    ...
    en: {
      ...
      homeTitle: "Tensura: Minesura",
      homeIntro: (n, m) => `Unofficial mod wiki. Documents the <strong>${n} Unique Skills</strong> naturally obtainable through reincarnation and the <strong>${m} commands</strong> added by the mod. Use the search box or the left menu to navigate.`,
      statUnique: "Unique Skills",
    ...
    pt: {
      ...
      homeTitle: "Tensura: Minesura",
      homeIntro: (n, m) => `Wiki não oficial do mod. Documenta as <strong>${n} Unique Skills</strong> obtidas naturalmente ao reencarnar e os <strong>${m} comandos</strong> adicionados pelo mod. Use a busca ou o menu à esquerda para navegar.`,
    ...
    fr: {
      ...
      homeTitle: "Tensura: Minesura",
      homeIntro: (n, m) => `Wiki non officiel du mod. Répertorie les <strong>${n} Unique Skills</strong> obtenues naturellement par réincarnation et les <strong>${m} commandes</strong> ajoutées par le mod. Utilisez la recherche ou le menu de gauche pour naviguer.`,
    ...
    de: {
      ...
      homeTitle: "Tensura: Minesura",
      homeIntro: (n, m) => `Inoffizielles Mod-Wiki. Dokumentiert die <strong>${n} Unique Skills</strong>, die man auf natürliche Weise durch Reinkarnation erhält, sowie die <strong>${m} Befehle</strong> des Mods. Nutze die Suche oder das Menü links zur Navigation.`,
    ...
    it: {
      ...
      homeTitle: "Tensura: Minesura",
      homeIntro: (n, m) => `Wiki non ufficiale della mod. Documenta le <strong>${n} Unique Skills</strong> ottenibili naturalmente reincarnandosi e i <strong>${m} comandi</strong> aggiunti dalla mod. Usa la ricerca o il menu a sinistra per navigare.`,
    ...
    ru: {
      ...
      homeTitle: "Tensura: Minesura",
      homeIntro: (n, m) => `Неофициальная вики мода. Описывает <strong>${n} Unique Skills</strong>, получаемых естественным образом при реинкарнации, и <strong>${m} команд</strong>, добавленных модом. Используйте поиск или меню слева для навигации.`,
    ...
    ja: {
      ...
      homeTitle: "Tensura: Minesura",
      homeIntro: (n, m) => `MODの非公式Wiki。転生で自然に入手できる<strong>${n}種のユニークスキル</strong>と、MODが追加する<strong>${m}種のコマンド</strong>を掲載しています。左のメニューまたは検索から移動してください。`,
    ...
    ko: {
      ...
      homeTitle: "Tensura: Minesura",
      homeIntro: (n, m) => `모드 비공식 위키입니다. 환생으로 자연스럽게 얻을 수 있는 <strong>${n}개의 유니크 스킬</strong>과 모드가 추가하는 <strong>${m}개의 명령어</strong>를 정리했습니다. 검색이나 왼쪽 메뉴로 이동하세요.`,
    ...
    zh: {
      ...
      homeTitle: "Tensura: Minesura",
      homeIntro: (n, m) => `本模组的非官方Wiki，收录了转生后可自然获得的<strong>${n}个固有技能</strong>，以及模组新增的<strong>${m}个指令</strong>。使用搜索框或左侧菜单进行导航。`,
    ...
    ar: {
      ...
      homeTitle: "Tensura: Minesura",
      homeIntro: (n, m) => `ويكي غير رسمي للمود. يوثّق <strong>${n} مهارة فريدة</strong> يمكن الحصول عليها بشكل طبيعي عبر التقمص، و<strong>${m} أمرًا</strong> يضيفها المود. استخدم البحث أو القائمة الجانبية للتنقل.`,
    ...
    hi: {
      ...
      homeTitle: "Tensura: Minesura",
      homeIntro: (n, m) => `मॉड की अनौपचारिक विकी। इसमें पुनर्जन्म से स्वाभाविक रूप से मिलने वाली <strong>${n} यूनिक स्किल्स</strong> और मॉड द्वारा जोड़े गए <strong>${m} कमांड्स</strong> का विवरण है। नेविगेट करने के लिए सर्च या बाईं ओर के मेनू का उपयोग करें।`,
    ...
    pl: {
      ...
      homeTitle: "Tensura: Minesura",
      homeIntro: (n, m) => `Nieoficjalna wiki moda. Opisuje <strong>${n} Unique Skills</strong> zdobywanych naturalnie poprzez reinkarnację oraz <strong>${m} komend</strong> dodanych przez moda. Użyj wyszukiwarki lub menu po lewej, aby nawigować.`,
    ...
    tr: {
      ...
      homeTitle: "Tensura: Minesura",
      homeIntro: (n, m) => `Modun resmi olmayan wiki'si. Reenkarnasyon yoluyla doğal olarak elde edilen <strong>${n} Unique Skill</strong> ile modun eklediği <strong>${m} komutu</strong> belgeler. Gezinmek için aramayı veya soldaki menüyü kullanın.`,
    ...
    nl: {
      ...
      homeTitle: "Tensura: Minesura",
      homeIntro: (n, m) => `Niet-officiële wiki van de mod. Documenteert de <strong>${n} Unique Skills</strong> die je op natuurlijke wijze via reïncarnatie krijgt, en de <strong>${m} commando's</strong> die de mod toevoegt. Gebruik de zoekbalk of het menu links om te navigeren.`,
